...
class _BodySettingState extends State<BodySetting> {
  ...
  Widget build(BuildContext context) {
    ...
    ValueNotifier<String> fullName =
        ValueNotifier(widget.ownerUserProfile.fullName);
                ...
                child: Column(
                  children: [
                    GestureDetector(
                          ...
                          setState(
                            () {
                              storage.uploadFile(
                                ...
                                fileName: widget.ownerUserProfile.email,
                      ...
                      child: Stack(
                        children: [
                          if (widget.ownerUserProfile.urlImage.isEmpty)
                            CircleAvatar(
                          ...
                          if (widget.ownerUserProfile.urlImage.isNotEmpty)
                            CircleAvatar(
                              backgroundColor: Colors.cyan[100],
                              radius: 60,
                              child: ClipOval(
                                child: SizedBox.fromSize(
                                  ...
                                  child: CachedNetworkImage(
                                    imageUrl: widget.ownerUserProfile.urlImage,
                                    fit: BoxFit.cover,
